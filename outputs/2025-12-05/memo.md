# 📜 SmartMoney Investment Memo — 2025-12-05
...
### CPRT — Copart Inc.
**Secteur:** Industrials | **Poids:** 13.0% | **Buffett Score:** 0.482
...
### AMZN — Amazon.com Inc.
**Secteur:** Consumer Cyclical | **Poids:** 13.0% | **Buffett Score:** 0.407
...
- **Indicateurs:** ROE 20.7% avec faible dette → capital efficiency
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
...
- **Rentabilité:** 🟢 ROE excellent (20.7%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### BKNG — Booking Holdings Inc.
**Secteur:** Consumer Cyclical | **Poids:** 13.0% | **Buffett Score:** 0.453
...
#### 🏰 Analyse du Moat
- **Types possibles:** Marque premium, Échelle, E-commerce
- **Indicateurs:** Marge nette élevée (24.8%) → pricing power
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
- **Vue Buffett sur le secteur:** _Prudence sur le timing, focus sur les leaders de catégorie_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 1.34x
...
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🔴 ROE faible (-1.5%)
- **Verdict:** _Bilan fragile - surveiller de près_

---

### AAPL — Apple Inc Common Stock
**Secteur:** Technology | **Poids:** 11.5% | **Buffett Score:** 0.482
...
### ADBE — Adobe Inc.
**Secteur:** Technology | **Poids:** 10.4% | **Buffett Score:** 0.468
...
#### 🏰 Analyse du Moat
- **Types possibles:** Network effects, Switching costs, Intangible assets (IP)
- **Indicateurs:** Marge nette élevée (25.9%) → pricing power; ROE 39.4% avec faible dette → capital efficiency; Marge brute élevée (89.0%) → différenciation
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
- **Vue Buffett sur le secteur:** _Difficile à évaluer, mais les leaders avec pricing power sont attractifs_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 1.42x
- **Assessment:** 🟢 Excellent - FCF supérieur au net income (earnings conservateurs)
- **Capex:** Capex faible - business asset-light (favorable)
...
- **Leverage:** 🟡 Leverage modéré (D/E < 0.8)
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🟢 ROE excellent (39.4%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### CB — Chubb Limited
**Secteur:** Financial Services | **Poids:** 6.2% | **Buffett Score:** 0.495
...
- **Indicateurs:** Marge nette correcte (17.2%)
...
- **Leverage:** 🟢 Fortress balance sheet (D/E < 0.3)
- **Liquidité:** 🔴 Risque liquidité (CR < 1)
- **Rentabilité:** 🟠 ROE moyen (14.1%)
- **Verdict:** _Bilan fragile - surveiller de près_

---

### CRM — Salesforce Inc.
**Secteur:** Technology | **Poids:** 5.7% | **Buffett Score:** 0.453
...
#### 🏰 Analyse du Moat
- **Types possibles:** Network effects, Switching costs, Intangible assets (IP)
- **Indicateurs:** Marge nette correcte (16.4%); Marge brute élevée (77.2%) → différenciation
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
- **Vue Buffett sur le secteur:** _Difficile à évaluer, mais les leaders avec pricing power sont attractifs_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 2.01x
- **Assessment:** 🟢 Excellent - FCF supérieur au net income (earnings conservateurs)
- **Capex:** Capex faible - business asset-light (favorable)
...
- **Leverage:** 🟢 Fortress balance sheet (D/E < 0.3)
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🟠 ROE moyen (10.1%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### ACGL — Arch Capital Group Ltd.
**Secteur:** Financial Services | **Poids:** 5.6% | **Buffett Score:** 0.495
...
#### 🏰 Analyse du Moat
- **Types possibles:** Économies d'échelle, Coûts de switching, Marque/confiance
- **Indicateurs:** Marge nette élevée (25.5%) → pricing power; ROE 20.7% avec faible dette → capital efficiency
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
- **Vue Buffett sur le secteur:** _Privilégier les assureurs avec float et les banques conservatrices_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 1.54x
- **Assessment:** 🟢 Excellent - FCF supérieur au net income (earnings conservateurs)
- **Capex:** Capex faible - business asset-light (favorable)
...
**Secteur:** Financial Services | **Poids:** 5.6% | **Buffett Score:** 0.442
...
#### 🏰 Analyse du Moat
- **Types possibles:** Économies d'échelle, Coûts de switching, Marque/confiance
- **Indicateurs:** Marge nette élevée (21.1%) → pricing power
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
- **Vue Buffett sur le secteur:** _Privilégier les assureurs avec float et les banques conservatrices_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 0.13x
...
- **Leverage:** 🟢 Fortress balance sheet (D/E < 0.3)
- **Liquidité:** 🟢 Liquidité excellente (CR > 2)
- **Rentabilité:** 🟠 ROE moyen (13.7%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### AON — Aon plc
**Secteur:** Financial Services | **Poids:** 4.8% | **Buffett Score:** 0.422
...
#### 🏰 Analyse du Moat
- **Types possibles:** Économies d'échelle, Coûts de switching, Marque/confiance
- **Indicateurs:** Marge nette correcte (17.3%); ROE solide (42.3%)
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
- **Vue Buffett sur le secteur:** _Privilégier les assureurs avec float et les banques conservatrices_
...
- **Leverage:** 🔴 Leverage excessif (D/E > 1.5)
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🟢 ROE excellent (42.3%)
- **Verdict:** _Bilan fragile - surveiller de près_
...
|---------|-------|-------------|
| Financial Services | 31.2% | Privilégier les assureurs avec float et les banque... |
| Technology | 30.0% | Difficile à évaluer, mais les leaders avec pricing... |
| Consumer Cyclical | 25.9% | Prudence sur le timing, focus sur les leaders de c... |
| Industrials | 13.0% | Préférer les businesses avec revenus récurrents (s... |
...
### Concentration
- 🟢 **Diversification correcte** : Top 3 = 38.9%
- 🟢 **Exposition sectorielle équilibrée** : Max = 31.2%
- 🟠 **Positions volatiles** : 2 titres avec vol > 40%
- 🔴 **ROE négatif** : BKNG
- 🟠 **Leverage élevé (D/E > 2)** : AON
