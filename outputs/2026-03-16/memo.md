# 📜 SmartMoney Investment Memo — 2026-03-16
...
### V — Visa Inc. Class A
**Secteur:** Financial Services | **Poids:** 10.5% | **Buffett Score:** 0.482
...
- **Indicateurs:** Marge nette élevée (32.8%) → pricing power; ROE 31.8% avec faible dette → capital efficiency; Marge brute élevée (59.6%) → différenciation
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
- **Vue Buffett sur le secteur:** _Network effects puissants mais valorisations souvent élevées_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 0.55x
...
- **Rentabilité:** 🟢 ROE excellent (31.8%)
- **Verdict:** _Bilan de qualité institutionnelle_

---

### PG — Procter & Gamble Co
**Secteur:** Consumer Defensive | **Poids:** 8.7% | **Buffett Score:** 0.467
...
**Secteur:** Consumer Defensive | **Poids:** 7.5% | **Buffett Score:** 0.433
...
#### 🏰 Analyse du Moat
- **Types possibles:** Marques fortes, Distribution, Habitudes consommateurs
- **Indicateurs:** Marge nette élevée (27.4%) → pricing power; ROE solide (38.3%); Marge brute élevée (61.6%) → différenciation
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
- **Vue Buffett sur le secteur:** _Cœur du portefeuille Buffett - cash flows prévisibles_
...
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🟢 ROE excellent (38.3%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### MSFT — Microsoft Corp.
**Secteur:** Technology | **Poids:** 6.9% | **Buffett Score:** 0.468
...
**Secteur:** Communication Services | **Poids:** 6.4% | **Buffett Score:** 0.468
...
#### 🏰 Analyse du Moat
- **Types possibles:** Contenu exclusif, Base utilisateurs, Données
- **Indicateurs:** Marge nette élevée (30.1%) → pricing power; ROE 27.8% avec faible dette → capital efficiency; Marge brute élevée (82.0%) → différenciation
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
- **Vue Buffett sur le secteur:** _Network effects puissants mais valorisations souvent élevées_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 0.76x
- **Assessment:** 🟠 Attention - FCF significativement inférieur (accruals élevés)
- **Capex:** Capex élevé - business capital-intensive
...
- **Leverage:** 🟡 Leverage modéré (D/E < 0.8)
- **Liquidité:** 🟢 Liquidité excellente (CR > 2)
- **Rentabilité:** 🟢 ROE excellent (27.8%)
- **Verdict:** _Bilan de qualité institutionnelle_

---

### UNP — Union Pacific Corporation
**Secteur:** Industrials | **Poids:** 6.2% | **Buffett Score:** 0.447
...
- **Liquidité:** 🔴 Risque liquidité (CR < 1)
- **Rentabilité:** 🟢 ROE excellent (38.6%)
- **Verdict:** _Bilan fragile - surveiller de près_

---

### EA — Electronic Arts Inc.
**Secteur:** Communication Services | **Poids:** 5.7% | **Buffett Score:** 0.495
...
### JNJ — Johnson & Johnson
**Secteur:** Healthcare | **Poids:** 4.8% | **Buffett Score:** 0.467
...
- **Indicateurs:** Marge nette élevée (28.5%) → pricing power; ROE solide (32.9%); Marge brute élevée (67.9%) → différenciation
- **Assessment:** 🟢 Moat probable - Indicateurs de pricing power et capital efficiency
...
- **Leverage:** 🟡 Leverage modéré (D/E < 0.8)
- **Liquidité:** 🟠 Liquidité correcte (CR > 1)
- **Rentabilité:** 🟢 ROE excellent (32.9%)
- **Verdict:** _Bilan acceptable avec quelques points d'attention_

---

### CTAS — Cintas Corporation
**Secteur:** Industrials | **Poids:** 4.6% | **Buffett Score:** 0.482
...
#### 🏰 Analyse du Moat
- **Types possibles:** Échelle/coûts, Relations clients, Certifications
- **Indicateurs:** Marge nette correcte (17.5%); ROE solide (38.7%); Marge brute élevée (50.0%) → différenciation
- **Assessment:** 🟡 Moat possible - Quelques avantages compétitifs
- **Vue Buffett sur le secteur:** _Préférer les businesses avec revenus récurrents (services, maintenance)_

#### 📈 Qualité des Earnings
- **FCF / Net Income:** 0.97x
- **Assessment:** 🟡 Correct - FCF proche du net income
- **Capex:** Capex faible - business asset-light (favorable)
...
- **Leverage:** 🟡 Leverage modéré (D/E < 0.8)
- **Liquidité:** 🟢 Liquidité excellente (CR > 2)
- **Rentabilité:** 🟢 ROE excellent (38.7%)
- **Verdict:** _Bilan de qualité institutionnelle_
...
|---------|-------|-------------|
| Financial Services | 29.1% | Privilégier les assureurs avec float et les banque... |
| Communication Services | 26.5% | Network effects puissants mais valorisations souve... |
| Consumer Defensive | 16.2% | Cœur du portefeuille Buffett - cash flows prévisib... |
| Industrials | 10.8% | Préférer les businesses avec revenus récurrents (s... |
| Technology | 9.8% | Difficile à évaluer, mais les leaders avec pricing... |
| Healthcare | 4.8% | Préférer les entreprises diversifiées avec revenus... |
| Basic Materials | 2.8% | Éviter sauf producteurs low-cost avec bilan solide... |
...
### Concentration
- 🟢 **Diversification correcte** : Top 3 = 29.5%
- 🟢 **Exposition sectorielle équilibrée** : Max = 29.1%
- 🟠 **Positions volatiles** : 1 titres avec vol > 40%
- 🟠 **Leverage élevé (D/E > 2)** : SHW
